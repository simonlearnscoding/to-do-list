...
export default class UI {
  ...
  static createMainSections() {
    ...
    let classNames = ["sidebar", "header", "tasks"];
  ...
  static createProjectContainers() {
    const ProjectContainer1 = UI.addHTML(
      "div",
      "",
      ["project-container", "default-projects"],
      "default-projects"
    );
    const ProjectContainer2 = UI.addHTML(
      "div",
      "",
      ["project-container", "user-projects"],
      "user-projects"
    );
...
class Elements {
  static createElements() {
    ...
    taskComponents.loadTasks("inbox");
